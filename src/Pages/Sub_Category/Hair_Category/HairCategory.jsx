...
//                 <div key={item.subcategoryid} className={`card-${index + 1}`}>
//                     {index % 2 === 0 ? (
//                         <>
//                             <div className="image">
//                                 <img src={imageMap[item.image]} style={{ width: "475px" }} />
//                             </div>
...
//                             <div className="description" dangerouslySetInnerHTML={{ __html: item.description }}></div>
//                             <div className="image">
//                                 <img src={imageMap[item.image]} style={{ width: "550px" }} />
//                             </div>
//                         </>
//                     )}
//                 </div>
